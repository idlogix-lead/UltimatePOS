        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li @if(request()->segment(2) == 'allowance-deduction') class="active" @endif><a href="{{action([Modules\Essentials\Http\Controllers\EssentialsAllowanceAndDeductionController::class,'index'])}}">@lang('essentials::lang.allowance_and_deduction')</a></li>
