        ...
        <tbody>
            ...
            @foreach($days as $day)
                <tr>
                    ...
                    <td><span class="display_currency gross-profit" data-currency_symbol="true" data-orig-value="{{$profits[$day] ?? 0}}">{{isset($profits[$day])?round(intval(strip_tags($profits[$day])),2) : 0}}</span></td>
                            @php
                                $total += $profits[$day] ?? 0;
                            @endphp
                </tr>
